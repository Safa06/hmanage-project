        ...
        function toggle_status(id, val) {
            ...
            xhr.onload = function() {
                if (this.responseText == 1) {
                    alert('success', 'Not Reserved');
                } else {
                    alert('danger', 'Reserved');
                }
        ...
        function add_image() {
            ...
            xhr.onload = function() {
                if (this.responseText == 'inv.img') {
                    ...
                    room_image(add_image_form.elements['room_id'].value, document.querySelector("#room-images  .modal-title").innerText);
