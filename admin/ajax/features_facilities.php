...
if(isset($_POST['get_features']))
{
    ...
    while($row=mysqli_fetch_assoc($res))
    {
        ...
        echo<<<data
          ...
          <td>$i</td>
          <td>$row[name]</td>
          <td><button type="button" onclick="rem_feature($row[id])" class="btn btn-sm btn-danger fw-bold h-font">
                Delete
             </button>
            </td>
          </tr>
...
if(isset($_POST['get_facilities']))
{
    ...
    while($row=mysqli_fetch_assoc($res))
    {
        ...
        echo<<<data
          ...
          <td><button type="button" onclick="rem_facility($row[id])" class="btn btn-sm btn-danger fw-bold h-font">
                Delete
             </button>
           </td>
          </tr>
